<template>
  <div class="z-20 bg-white">
    <nav class="fixed inset-x-0 container mx-auto p-6 bg-transparent">
      <div class="flex items-center justify-between">
        <!-- Header logo -->
        <div>
          <h1 class="text-2xl font-medium">Blood Donor</h1>
        </div>
        ...
        <div class="hidden md:block">
          <ul class="flex space-x-8 text-lg font-sans">
            <li><a href="#" class="pb-1 text-white">Log In</a></li>
            <li>
              <a
                href="#"
                class="
                  ...
                  font-semibold bg-transparent hover:bg-white
                "
                >Sign Up</a
              >
            </li>
