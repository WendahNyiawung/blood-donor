<template>
    ...
    <section class="container p-6 mx-auto bg-white dark:bg-gray-800">
        <h2 class="text-xl font-medium text-gray-800 capitalize dark:text-white md:text-2xl">Recent Donors</h2>
            ...
            <div class="grid gap-8 mt-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div class="w-full max-w-xs text-center">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="mt-1 font-medium text-gray-600 dark:text-gray-300">Blood Group B</span>
                    </div>
                </div>
                ...
                <div class="w-full max-w-xs text-center">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="mt-1 font-medium text-gray-600 dark:text-gray-300">Blood Group AB</span>
                    </div>
                </div>
                ...
                <div class="w-full max-w-xs text-center">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="mt-1 font-medium text-gray-600 dark:text-gray-300">Blood Group A+</span>
                    </div>
                </div>
                ...
                <div class="w-full max-w-xs text-center">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="mt-1 font-medium text-gray-600 dark:text-gray-300">Blood Group O</span>
                    </div>
                </div>
            </div>
        </div>
